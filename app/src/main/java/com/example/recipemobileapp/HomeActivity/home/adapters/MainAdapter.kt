...
class MainAdapter(val data:MutableList<Meal>,  private val onRecipeClick: (Meal) -> Unit,private val onFavClick: (pos:Int) -> Unit) : RecyclerView.Adapter<MainAdapter.MyViewHolder>() {
